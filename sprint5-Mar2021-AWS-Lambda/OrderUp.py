...
def create_data(restaurant_id):
    try:
        ...
        r = http.request('POST', "https://stevesie.com/cloud/api/v1/endpoints/92e9a78f-8e40-46c1-bc5c-f3b37ecb33de/executions",
                     headers={'Token': "b90ea26c-cd3e-4a26-be92-5f235d4b1dbc"},
                     body=encoded_data)
        ...
        data = {
            ...
            "inputs": {
                ...
                "auth_token": response_json["session_handle"]["access_token"]
            }
        }
        encoded_data = json.dumps(data).encode('utf-8')

        
        r = http.request('POST', "https://stevesie.com/cloud/api/v1/endpoints/e35c15d5-0ff5-4d8d-bc16-7da5f22ff866/executions",
                     headers={'Token': "b90ea26c-cd3e-4a26-be92-5f235d4b1dbc"},
                     body=encoded_data)
        response_json = json.loads(r.data.decode('utf-8'))
        response_json = response_json['object']['response']['response_json']
        ...
        print('completed stevesie request')
...
class Requests:
    ...
    def create_marchent(self):
        ...
        self.r = http.request('POST', 'https://api.staging.orderup.ai/merchant',
                         headers={'Authorization': 'Bearer hMLsrTVzDwDgea3D0Ghl0Rh51ytlDmUYNK8Fj1MD3GQ',
